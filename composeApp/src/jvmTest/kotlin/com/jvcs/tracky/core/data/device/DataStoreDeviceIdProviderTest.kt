...
internal class DataStoreDeviceIdProviderTest {
    ...
    @Test
    fun theFirstCallMintsAUuid() = runTest {
    ...
    @Test
    fun theSameInstanceReturnsTheSameIdEveryTime() = runTest {
        val provider = DataStoreDeviceIdProvider(createTestDataStore())
    ...
    @Test
    fun aFreshProviderReadsTheMintedIdBackRatherThanMintingAgain() = runTest {
    ...
    @Test
    fun twoStoresAreTwoDevices() = runTest {
    ...
    @Test
    fun concurrentFirstCallsAllSeeOneId() = runTest {
        val provider = DataStoreDeviceIdProvider(createTestDataStore())
    ...
    @Test
    fun concurrentFirstCallsOnSeparateProvidersAlsoSeeOneId() = runTest {
        val store = createTestDataStore()
