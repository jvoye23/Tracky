...
internal class SyncPullCoordinatorTest {
    ...
    private fun coordinator(scope: kotlinx.coroutines.CoroutineScope) = SyncPullCoordinator(
     ...
     */
    @Test
    fun aBurstOfRequestsCostsOnePull() = runTest {
    ...
    @Test
    fun requestsArrivingAfterAPullHasRunEarnAnotherOne() = runTest {
        val coordinator = coordinator(backgroundScope)
    ...
    @Test
    fun concurrentPullsAreSerialised() = runTest {
        val coordinator = coordinator(backgroundScope)
    ...
    @Test
    fun aCoalescedRequestAndAnAwaitedPullDoNotOverlapEither() = runTest {
        val coordinator = coordinator(backgroundScope)
    ...
    @Test
    fun doesNothingUntilAsked() = runTest {
