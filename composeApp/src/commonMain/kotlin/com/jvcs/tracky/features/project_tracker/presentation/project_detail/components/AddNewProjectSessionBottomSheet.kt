...
import tracky.composeapp.generated.resources.enter_session_name


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AddNewProjectSessionBottomSheet(
...
private fun SheetContent(
    ...
    Column(
        ...
        TextField(
            state = state.addProjectSessionTextFieldState,
            modifier = modifier
                .fillMaxWidth()
        ...
        Row(
            ...
            Button(
                ...
                onClick = {
                    onAction(ProjectDetailAction.OnCreateProjectSession(projectSessionTitle = state.addProjectSessionTextFieldState.text as String))
                }
            ) {
                Text(
                    modifier = Modifier
