...
class OfflineFirstSubTaskIntervalRepository(
    ...
    private suspend fun writeThenPush(interval: SubTaskInterval, isCreate: Boolean): EmptyResult<DataError> {
    ...
    override suspend fun getOpenIntervalBySubTaskId(subTaskId: String): Result<SubTaskInterval?, DataError> =
    ...
    override suspend fun deleteSubTaskInterval(intervalId: String): EmptyResult<DataError> {
        val interval =
            localSubTaskIntervalDataSource
                .getSubTaskIntervalById(intervalId)
     ...
     *   feature exists for.
     */
    private suspend fun pushInterval(interval: SubTaskInterval, isCreate: Boolean): EmptyResult<DataError> {
        val subTaskId = interval.parentSubTaskId
    ...
    private suspend fun parentTaskIdOf(subTaskId: String): String? = parentSubTaskOf(subTaskId)?.parentProjectTaskId
