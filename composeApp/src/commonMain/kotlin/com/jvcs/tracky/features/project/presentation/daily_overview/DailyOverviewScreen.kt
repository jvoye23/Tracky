...
import com.jvcs.tracky.features.project.presentation.daily_overview.components.DayIntervalCard
import com.jvcs.tracky.features.project.presentation.daily_overview.components.previewCalendarMonth
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        text = stringResource(Res.string.daily_overview_title).uppercase(),
                        style = MaterialTheme.typography.labelMedium,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                },
                navigationIcon = {
                    IconButton(onClick = { onAction(DailyOverviewAction.OnBackClick) }) {
                        Icon(
