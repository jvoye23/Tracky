                ...
                Surface(
                    ...
                    Row(
                        ...
                        BasicTextField(
                            ...
                            onValueChange = { onAction(ProjectArchiveAction.OnSearchQueryChange(it)) },
                            modifier = Modifier
                                .weight(1f)
                            ...
                            decorationBox = { innerTextField ->
                                if (state.searchQuery.isEmpty()) {
                                    Text(
                                        text = stringResource(Res.string.search_in_archive),
...
@Composable
private fun ProjectArchiveTopBarPreview() {
    TrackyTheme {
...
@Preview(showSystemUi = true, device = Devices.PIXEL_9_PRO)
@Composable
private fun ProjectArchiveTopBarSearchPreview() {
    TrackyTheme {
        ProjectArchiveTopBar(
            state = ProjectArchiveState(isSearchActive = true, searchQuery = "Design"),
            onAction = {},
            onMenuClick = {},
            scrollBehavior = TopAppBarDefaults.enterAlwaysScrollBehavior()
        )
