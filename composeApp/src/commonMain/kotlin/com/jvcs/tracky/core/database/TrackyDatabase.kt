...
abstract class TrackyDatabase : RoomDatabase() {
    ...
    abstract val projectTreeDao: ProjectTreeDao
    abstract val sortOrderDao: SortOrderDao
        ...
        val MIGRATION_10_11 =
            object : Migration(10, 11) {
                override fun migrate(connection: SQLiteConnection) {
                    ...
                    connection.execSQL(
                        "ALTER TABLE project_records RENAME COLUMN updatedAtEpochMs_tmp TO updatedAtEpochMs",
                    )
                }
            }
