...
class RoomPendingSyncDataSource(private val pendingSyncDao: PendingSyncDao) : PendingSyncDataSource {
    ...
    override suspend fun hasPendingCreate(entityId: String): Result<Boolean, DataError.Local> =
        dbRead {
            pendingSyncDao
                .getOperationsByEntityId(entityId)
...
private fun PendingSyncEntity.toPendingSyncOperation() =
