// Tracky Icons — exports Icon, GoogleLogo, AppleLogo to window

function Icon({ name, size = 20, color = 'currentColor' }) {
  const s = size, c = color;
  const props = { width: s, height: s, viewBox: '0 0 24 24', fill: 'none', stroke: c, strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round' };
  const fp = { width: s, height: s, viewBox: '0 0 24 24' };
  switch (name) {
    case 'timer':       return <svg {...props}><circle cx="12" cy="12" r="9"/><polyline points="12 6 12 12 16 14"/></svg>;
    case 'play':        return <svg {...fp} fill={c}><polygon points="5 3 19 12 5 21 5 3"/></svg>;
    case 'pause':       return <svg {...fp} fill={c}><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>;
    case 'stop':        return <svg {...fp} fill={c}><rect x="3" y="3" width="18" height="18" rx="2"/></svg>;
    case 'plus':        return <svg {...props} strokeWidth={2.5}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>;
    case 'trash':       return <svg {...props}><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>;
    case 'search':      return <svg {...props}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>;
    case 'chevLeft':    return <svg {...props} strokeWidth={2.5}><polyline points="15 18 9 12 15 6"/></svg>;
    case 'chevRight':   return <svg {...props} strokeWidth={2.5}><polyline points="9 18 15 12 9 6"/></svg>;
    case 'chevDown':    return <svg {...props} strokeWidth={2.5}><polyline points="6 9 12 15 18 9"/></svg>;
    ...
    case 'eyeOff':      return <svg {...props}><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>;
    ...
    case 'x':           return <svg {...props} strokeWidth={2.5}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>;
    case 'arrowBack':   return <svg {...props} strokeWidth={2.5}><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>;
    case 'sort':        return <svg {...props}><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="12" x2="14" y2="12"/><line x1="4" y1="18" x2="10" y2="18"/></svg>;
    case 'dots':        return <svg {...props} fill={c} stroke="none"><circle cx="12" cy="5" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="12" cy="19" r="1.5"/></svg>;
    default:            return null;
  }
}

function GoogleLogo({ s = 20 }) {
  return (
...
function AppleLogo({ s = 20, color = 'currentColor' }) {
  return (
...
Object.assign(window, { Icon, GoogleLogo, AppleLogo });
